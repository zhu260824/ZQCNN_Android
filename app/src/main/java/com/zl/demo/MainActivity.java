...
public class MainActivity extends AppCompatActivity {
    ...
    private MTCNNNCHWC mtcnnnchwc;
//    private ZQCNNSSD zqcnnssd;
//    private ZQMTCNN zqmtcnn;
    private String imgPath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "zqcnn";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtcnnnchwc = new MTCNNNCHWC();
        mtcnnnchwc.init(MainActivity.this);
//        zqcnnssd=new ZQCNNSSD();
//        zqcnnssd.init(MainActivity.this);
//        zqmtcnn=new ZQMTCNN();
//        zqmtcnn.init(MainActivity.this);
...
//        byte[] data = ImageUtil.bitmapToNv21(bitmap, bitmap.getWidth(), bitmap.getHeight());
        float[] faces = mtcnnnchwc.detectFace(imgPath + File.separator + assetsPath);
//              float[] faces = zqcnnssd.detectFace(imgPath + File.separator + assetsPath);
//        float[] faces = zqmtcnn.detectFace(imgPath + File.separator + assetsPath);
